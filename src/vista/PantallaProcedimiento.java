 ...
 * @author estebanfcv
 */
public class PantallaProcedimiento extends javax.swing.JFrame {

    /**
     * Creates new form PantallaProcedimiento
     */
    ...
    private void initComponents() {
        ...
        setTitle("Log");
        setPreferredSize(new java.awt.Dimension(1201, 591));
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PantallaProcedimiento().setVisible(true);
            }
        });
    }
